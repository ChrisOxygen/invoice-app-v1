                ...
                <div className="bill-from-section__fields section-field">
                  ...
                  <div className="form-row form-row--2">
                    ...
                    <div className="input-box">
                      ...
                      <input
                        className={`${errors.billFromPostCode && "has-error"}`}
                        type="text"
                        id="post-code"
                ...
                <div className="bill-to-section__fields section-field">
                  <div className="form-row form-row--1">
                    <div className="input-box">
                      ...
                      <input
                        className={`${errors.billToClientName && "has-error"}`}
                        type="text"
                        id="client-name"
                    ...
                    <div className="input-box">
                      ...
                      <input
                        className={`${errors.billToClientEmail && "has-error"}`}
                        type="email"
                        id="client-email"
                  ...
                  <div className="form-row form-row--3">
                    ...
                    >
                      ...
                      <Controller
                        ...
                        name="paymentTerms"
                        render={({ field: { onChange, value } }) => (
                          <PaymentTerms onChange={onChange} selected={value} />
                        )}
                      />
                      {errors.paymentTerms && (
                        <span className="error">
                        ...
                        <div className="table-item table-row" key={field.id}>
                          ...
                          <span className="table-item__price col col--price">
                            ...
                            <input
                              ...
                              type="number"
                              {...register(`service.${index}.price` as const, {
                                valueAsNumber: true,
                                required: "This field is required",
                                onChange(event) {
                          ...
                          <span className="table-item__total col col--total">
                            ...
                            <input
                              type="number"
                              readOnly
                              {...register(`service.${index}.total` as const, {
                                valueAsNumber: true,
                                required: "This field is required",
                              })}
                            />
